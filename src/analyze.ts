...
// Function to send formatted job listing to ChatGPT for suitability analysis
...
Additional rule:
- Do not consider the applicant's current employment status or salary requirements.
- Do not consider the locatation of the job.
...
async function processJobListings() {
  ...
  console.log('Count job listing:', jobListings.length);
  const chunkSize = 10;
